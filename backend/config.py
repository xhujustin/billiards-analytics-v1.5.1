...
# 球桿雷射軸線時序穩定
# CUE_AXIS_CACHE_MAX_MISSING_FRAMES: YOLO 短暫漏檢 cue 時，沿用上一條可信軸線的最大幀數
# CUE_AXIS_SMOOTH_ALPHA / CUE_AXIS_LASER_ONLY_SMOOTH_ALPHA: 越高越穩，越低越跟手
# CUE_AXIS_RESET_SHIFT_RATIO / MIN / MAX: 新軸線中心與快取差太遠時視為換桿或誤檢，重置平滑
# CUE_AXIS_NORMAL_DEADBAND_PX: 垂直球桿方向的小幅抖動死區，用於降低雷射線上下微飄
# CUE_AXIS_FAST_CONVERGE_SHIFT_PX: 中心位移超過此值時啟用快速收斂，避免雷射線慢慢追球桿
# CUE_AXIS_FAST_CONVERGE_ALPHA / CUE_AXIS_LASER_ONLY_FAST_CONVERGE_ALPHA: 快速收斂時的舊軸線保留權重，越低越跟手
...
# BALL_ANNOTATION_RADIUS_PADDING: 後端診斷畫面球外框額外外擴像素；保持小值讓框線貼球
# BALL_GEOMETRY_TEMPORAL_SMOOTH_ENABLED: 啟用球心/半徑短時序平滑，降低 segmentation 輪廓跳動
# BALL_GEOMETRY_TEMPORAL_MATCH_DIST: 同顆球跨幀匹配最大中心距離
# BALL_GEOMETRY_TEMPORAL_ALPHA: 舊幾何保留權重；越高越穩但移動跟隨越慢
# BALL_GEOMETRY_TEMPORAL_MAX_AGE: 幾何快取保留幀數
